                    ...
                    <tr>
                        <th>
                            <div class="custom-control custom-control-danger custom-checkbox">
                                <input type="checkbox" name="main_checkbox" class="custom-control-input"
                                    id="colorCheckq5" />
                        ...
                        <th>Weight</th>
                        <th>Status</th>
                        <th>Action<button class="btn btn-sm btn-danger d-none" id="deleteAllBtn">DeleteAll</button></th>
                    </tr>
                </thead>
            </table>
        </div>
